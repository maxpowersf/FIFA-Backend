...
namespace Ranking.Data.Migrations
{
    ...
    [Migration("20190729235033_Added Teams list to Confederations entity")]
    partial class AddedTeamslisttoConfederationsentity
    {
            ...
            modelBuilder.Entity("Ranking.Data.Entities.Teams", b =>
                {
                    ...
                    b.Property<int?>("ConfederationsConfederationID");
                    ...
                    b.HasIndex("ConfederationsConfederationID");
            ...
            modelBuilder.Entity("Ranking.Data.Entities.Teams", b =>
                {
                    ...
                    b.HasOne("Ranking.Data.Entities.Confederations")
                        .WithMany("Teams")
                        .HasForeignKey("ConfederationsConfederationID");
                });
